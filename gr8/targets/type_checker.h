// $Id: type_checker.h,v 1.7 2018/05/21 00:05:17 ist424879 Exp $ -*- c++ -*-
...
namespace gr8 {
  ...
  class type_checker: public basic_ast_visitor {
    ...
    bool declareAsGlobal = false;
    int size_of_args = 0;
    basic_type* objectType;
  ...
  protected:
    ...
    void processUnaryExpressionDoubles(cdk::unary_expression_node * const node, int lvl);
    void processBinaryExpression(cdk::binary_expression_node * const node, int lvl);
    void processBinaryExpressionInts(cdk::binary_expression_node * const node, int lvl);
    template<typename T>
