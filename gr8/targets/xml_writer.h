...
namespace gr8 {
  ...
  private:
    ...
    void visit(bool b, int lvl){
        os() << std::string(lvl, ' ') + (b ? "true" : "false") << std::endl;
    }
    
     void visit(int i, int lvl){
        os() << std::string(lvl, ' ') << i << std::endl;
    }
    
     void visit(std::string s, int lvl){
        os() << std::string(lvl, ' ') << s << std::endl;
    }
